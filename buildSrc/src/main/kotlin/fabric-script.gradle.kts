...
dependencies {
    ...
    add("modCompileOnly", "net.fabricmc.fabric-api:fabric-api:${outlet.fapiVersion()}")
    add("modLocalRuntime", "net.fabricmc.fabric-api:fabric-api:${outlet.fapiVersion()}")
    ...
    add("modCompileOnly", "net.fabricmc:fabric-language-kotlin:$flkVersion")
    add("modLocalRuntime", "net.fabricmc:fabric-language-kotlin:$flkVersion")

    //
    // Permissions configuration
    //
    val fabricPermAPI by properties // doesn't update their version tags good enough for auto...
    val fabricPermissions = "me.lucko:fabric-permissions-api:$fabricPermAPI"
    add("modCompileOnly", fabricPermissions)
    add("modLocalRuntime", fabricPermissions)
    include(fabricPermissions)
